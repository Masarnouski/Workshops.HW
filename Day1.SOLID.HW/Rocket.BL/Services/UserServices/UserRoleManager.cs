...
namespace Rocket.BL.Services.UserServices
{
    public class UserRoleManager : BaseService, IUserRoleManager
    {
        ...
        public virtual async Task<IdentityResult> AddToRoleAsync(string userId, string roleId = DefaultRoleId)
        {
        ...
        public virtual async Task<IdentityResult> RemoveFromRoleAsync(string userId, string roleId)
        {
        ...
        //public bool RemoveFromRole(string userId, string roleId)
        //{
        ...
        //public IEnumerable<DbRole> GetRoles(string userId)
        //{
        ...
        //        return dbUser.Roles.Select(t=> Mapper.Map<DbRole>(t));
        //}
        ...
        /// <param name="roleId"> Идентификатор роли. </param>
        /// <returns>bool</returns>
        public virtual async Task<bool> IsInRoleAsync(string userId, string roleId)
        {
