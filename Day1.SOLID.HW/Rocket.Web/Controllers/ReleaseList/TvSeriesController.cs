...
namespace Rocket.Web.Controllers.ReleaseList
{
    ...
    public class TvSeriesController : ApiController
    {
        ...
        private readonly ITvSeriesPersonsService _tvSeriesPersonsService;
        private readonly ITvSeriesSeasonsService _tvSeriesSeasonsService;

        public TvSeriesController(ITvSeriesService tvSeriesService,
            ITvSeriesPersonsService tvSeriesPersonsService,
            ITvSeriesSeasonsService tvSeriesSeasonsService)
        {
            _tvSeriesService = tvSeriesService;
            _tvSeriesPersonsService = tvSeriesPersonsService;
            _tvSeriesSeasonsService = tvSeriesSeasonsService;
        }
        ...
        {
            var tvSeries = _tvSeriesSeasonsService.GetSeasons(id);
            return tvSeries == null ? (IHttpActionResult)NotFound() : Ok(tvSeries);
        }
        ...
        {
            var tvSeries = _tvSeriesPersonsService.GetPersons(id);
            return tvSeries == null ? (IHttpActionResult)NotFound() : Ok(tvSeries);
        }
    }
}