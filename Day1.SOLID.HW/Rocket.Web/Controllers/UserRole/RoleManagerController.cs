...
namespace Rocket.Web.Controllers.UserRole
{
    ...
    public class RoleManagerController : ApiController
    {
        ...
        {
            var result = await _roleManager.AddToRoleAsync(userId, roleId);
        ...
        {
            var removeResult = await _roleManager.RemoveFromRoleAsync(userId, roleId);
        ...
        {
            var isInRoleResult = await _roleManager.IsInRoleAsync(userId, roleId);
